...
import "../../pooltogether-pool-contracts/contracts/reserve/ReserveInterface.sol";
import "../../pooltogether-pool-contracts/contracts/prize-pool/YieldSource.sol";
import "../../pooltogether-pool-contracts/contracts/token/TokenListenerInterface.sol";
import "../../pooltogether-pool-contracts/contracts/token/ControlledToken.sol";
import "../../pooltogether-pool-contracts/contracts/token/TokenControllerInterface.sol";
import "../../pooltogether-pool-contracts/contracts/utils/MappedSinglyLinkedList.sol";
import "../../pooltogether-pool-contracts/contracts/utils/RelayRecipient.sol";
import "./WhirlpoolPrizePoolInterface.sol";
import "./tornado/PoolTornado.sol";

/// @title Escrows assets and deposits them into a yield source.  Exposes interest to Prize Strategy.  Users deposit and withdraw from this contract to participate in Prize Pool.
/// @notice Accounting is managed using Controlled Tokens, whose mint and burn functions can only be called by this contract.
/// @dev Must be inherited to provide specific yield-bearing asset control, such as Compound cTokens
abstract contract WhirlpoolPrizePool is PoolTornado, WhirlpoolPrizePoolInterface, YieldSource, OwnableUpgradeSafe, RelayRecipient, ReentrancyGuardUpgradeSafe, TokenControllerInterface {
  ...
  mapping(bytes32 => uint256) internal _timelockBalances;
  ...
  constructor(
    ...
    address _operator,
    address _token
    ) PoolTornado(_verifier, _denomination, _merkleTreeHeight, _operator, _token) public {
  }
    ...
    nonReentrant
  {
    ...
    _timelockBalances[commitment] = _timelockBalances[commitment].sub(amount);
