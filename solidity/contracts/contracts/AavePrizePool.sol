...
import "../../pooltogether-pool-contracts/contracts/prize-pool/PrizePool.sol";
...
contract AavePrizePool is PrizePool {
  ...
  event AavePrizePoolInitialized(address indexed aToken);
    ...
    initializer
  {
    ...
    emit AavePrizePoolInitialized(address(aToken));
  }
